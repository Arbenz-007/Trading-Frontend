            ...
            <div className="lg:flex gap-32">
              <div className="space-y-7">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{auth.user?.fullName.charAt(0).toUpperCase()+auth.user?.fullName.slice(1)}</p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">Date of Birth : </p>
                  <p className="text-gray-500">09/10/2000</p>
                </div>
                <div className="flex">
              ...
              <div className="space-y-7">
                <div className="flex">
                  ...
                  <p className="text-gray-500">rayan1234@gmail.com</p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">City : </p>
                  <p className="text-gray-500">Md Rayyan</p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">Date of Birth : </p>
                  <p className="text-gray-500">09/10/2000</p>
            ...
            <CardHeader className="pb-7">
              <div className="flex items-center gap-3">
                ...
                {true ? (
                  ...
                  <Badge className={`bg-orange-400`}>Disabled</Badge>
                )}
              </div>
            </CardHeader>
            <CardContent>
