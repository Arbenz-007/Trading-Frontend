...
{withdrawal?.paymentDetails ?     <Card>
        <CardHeader>
          ...
          <CardDescription>A/C No : {"*".repeat(Math.max(0, (withdrawal?.paymentDetails?.accountNumber?.length || 0) - 4)) + withdrawal?.paymentDetails?.accountNumber?.slice(-4)}</CardDescription>
        </CardHeader>
        <CardContent>
